...
export default function SignupStep2() {
  ...
  const countryLabel = useMemo(() => COUNTRIES.find((c) => c.code === country)?.label ?? "", [country]);
            ...
            <View className="bg-white dark:bg-neutral-900 rounded-t-2xl p-2 max-h-[70%]">
              <FlatList
                ...
                renderItem={({ item }) => (
                  ...
                  >
                    <Text className="text-base text-neutral-900 dark:text-neutral-50">{item.label}</Text>
                  </Pressable>
                )}
              />
            </View>
