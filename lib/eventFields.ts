...
export const EVENT_FIELD_SPECS: EventFieldSpec[] = [
  ...
  { key: "hosting", column: "is_external", private: "ALWAYS", public: "ALWAYS", note: "in_app (default) or external. Controls whether registration happens in-app or externally." },
  { key: "registration_url", column: "registration_url", private: "CONDITIONAL", public: "CONDITIONAL", condition: "Mandatory only when hosting is external.", note: "Mandatory + valid URL when external, optional when in_app." },
