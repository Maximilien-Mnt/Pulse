...
export const SPORT_LEVELS: Record<SportId, string[]> = {
  ...
  fitness: withOther(["Débutant", "<6 mois", "6 mois-1 an", "1-2 ans", "2-3 ans", "3-5 ans", "5-10 ans", ">10 ans"]),
...
export const SPORT_PRACTICES: Record<SportId, string[]> = {
  ...
  fitness: withOther(["Musculation", "Cardio", "HIIT", "Yoga/Pilates", "Remise en forme", "Hypertrophie", "Force", "Cross-training", "Préparation athlétique"]),
